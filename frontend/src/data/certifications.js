export const certifications = [
  ...
  },
  {
    ...
    description:
      "A 12-course series by IBM covering Python programming, data analysis, visualization, SQL, and machine learning. This program included hands-on projects and a capstone project, equipping me with the skills to analyze and derive insights from real-world data.",
    image:
      "/Images/Certifications/IBM Professional Certificate For Data Science.png",
    link: "https://coursera.org/share/86040f43745391bb89e3fa8fe317d86f",
  },
  {
    id: 2,
    ...
    tag: "Web Design",
    description:
      "Earned the Responsive Web Design Certification from freeCodeCamp by completing over 300 hours of coursework. Developed expertise in HTML, CSS, and modern web design principles, including Flexbox, Grid, and responsive layouts.",
    image: "/Images/Certifications/Responsive Web Design (FreeCodeCamp).png",
  ...
  {
    id: 6,
    title: "HTML-5 Essential Training",
    ...
    tag: "Web Development",
    description:
      "Mastered semantic markup, form controls, embedding media, and modern web standards. This certification validates my proficiency in creating accessible, well-structured HTML documents.",
    image: "/Images/Certifications/HTML-5 Linkedin Certificate.png",
